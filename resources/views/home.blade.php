...
<head>
    ...
    <title>
        Agency Hotspot  | MegaOne HTML5 Template
    </title>
...
<body data-spy="scroll" data-target=".navbar" data-offset="90">
        ...
        <div class="main_container">
            <div class="side_nav">
                <div class="my-sticky-nav">
                    <div class="side_menu">
                        <a class="brand-logo link" href="index-agency-hotspot.html">
                            <img src="assets/images/logo.png" alt="logo" style="height: 87%;width: 87%;"/>
                        </a>
                        ...
                        <div>
                            <a class="brand-logo sticky-logo link" href="index-agency-hotspot.html">
                                <img src="assets/images/logo.png" alt="logo" style="height: 80%;width: 80%;"/>
                            </a>
                        </div>
                        <nav class="side-nav-menu">
                            <ul class="nav-menu nav-fill" id="menu">
                                <li class="nav-item">
                                    <a data-menuanchor="home-banner" class="nav-link link active line" href="#home-banner">
                                        Home 
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a data-menuanchor="about" class="nav-link link line" href="#about">
                                        About Agency
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a data-menuanchor="team" class="nav-link link line" href="#team">
                                        Our Team
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a data-menuanchor="portfolio" class="nav-link link line" href="#portfolio">
                                        Portfolio
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a data-menuanchor="blog" class="nav-link link line" href="#blog">
                                        Our Blog
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a data-menuanchor="contact" class="nav-link link line" href="#contact">
                                        Contact
                                    </a>
                                </li>
                            </ul>
                            ...
                            <p class="rites-res link">
                                ...
                                Made with love by Themes Industry
                            </p>
                        </nav>
                    </div>
                </div>
            ...
            <header id="home">
                <nav class="navbar navbar-light bg-light cursor-light d-md-none">
                    ...
                    <a class="navbar-brand ml-auto" href="index-agency-hotspot.html">
                        <img src="assets/images/logo.png" alt="Logo" style="height: 100%;width: 100%;">
                    </a>
                </nav>
                <div class="broad">
                    ...
                    <nav class="side-nav-menu">
                        <a class="brand-logo" href="index-agency-hotspot.html">
                            <img src="assets/images/logo.png" alt="Logo" style="height: 90%;width: 90%;"/>
                        </a>
    ...
    <div id="pagepiling">
        <section class="section slide1 p-0" id="home-banner">
            <div class="slider-area" id="slider-area">
                <div class="bg-overlay bg-green opacity-8">
                </div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-12 col-md-6 section1left wow" data-wow-delay=".8s">
                            <h1 class="main-font font-weight-bold text-white">
                                Web Design 
                                <span class="d-block">
                                    Agency in NY.
                                </span>
                            </h1>
                            <p class="alt-font text-white my-4">
                                Lorem ipsum is simply dummy text of the printing and typesetting. Lorem Ipsum has been the industry’s standard dummy. 
                            </p>
                            <a href="#about" class="btn btn-medium btn-rounded btn-trans text-capitalize mb-4 mb-md-0">
                                Learn More
                            </a>
                        </div>
                        <div class="col-12 col-md-6 section1right wow" data-wow-delay=".8s">
                            <div class="banner-image">
                                <svg class="slider-shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 700">
                                    ...
                                    <image data-depth="0.1" clip-path="url(#shape-img)" height="100%" width="100%" xlink:href="assets/images/slider-img.png" />
                                </svg>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section slide2 about" id="about">
            <div class="bg-overlay bg-pink opacity-8">
            </div>
                ...
                <div class="row pb-5">
                    <div class="col-12 col-md-3 about-zoom1In wow" data-wow-delay=".2s">
                        <div class="feature-item text-center text-md-left">
                            <i class="las la-laptop f-icon">
                            </i>
                            <h5 class="title main-font mt-1">
                                Web Design
                            </h5>
                            <p class="alt-font mt-3">
                    ...
                    <div class="col-12 col-md-3 about-zoom2In wow" data-wow-delay=".4s">
                        <div class="feature-item text-center text-md-left">
                            <i class="las la-pen-fancy f-icon">
                            </i>
                            <h5 class="title main-font mt-1">
                                Logo Designs
                            </h5>
                    ...
                    <div class="col-12 col-md-3 about-zoom3In wow" data-wow-delay=".6s">
                        <div class="feature-item text-center text-md-left">
                            <i class="las la-digital-tachograph f-icon">
                            </i>
                            <h5 class="title main-font mt-1">
                                SEO Marketing
                            </h5>
                ...
                <div class="box position-relative about-zoom5In wow" data-wow-delay=".5s">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12 col-md-7 col-lg-9">
                            ...
                            <p class="py-4 py-md-0">
                                Lorem ipsum is simply dummy text of the printing and typesetting. Lorem Ipsum has been the industry’s standard dummy. 
                            </p>
                        </div>
                        <div class="col-12 col-md-5 col-lg-3 text-center">
                            <a href="#contact" class="btn btn-medium btn-rounded btn-trans text-capitalize">
                                Learn More
                            </a>
                        </div>
                    </div>
        ...
        <section class="section slide3 team" id="team">
            <div class="bg-overlay bg-yellow opacity-8">
            </div>
            <div class="container expand-container">
                ...
                <div class="row team-fade wow" data-wow-delay=".8s">
                    <div class="col-sm-12">
                        <div id="team-slider" class="owl-carousel owl-theme wow fadeInUp">
                            <div class="team-box item">
                                ...
                                <div class="team-text">
                                    ...
                                    <div class="team-social">
                                        <ul class="list-unstyled">
                                            <li>
                                                <a class="facebook-bg-hvr" href="javascript:void(0);">
                                                    <i class="fab fa-facebook-f" aria-hidden="true">
                                                    </i>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="twitter-bg-hvr" href="javascript:void(0);">
                                                    <i class="fab fa-x-twitter" aria-hidden="true">
                                                    </i>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="google-bg-hvr" href="javascript:void(0);">
                                                    <i class="fab fa-google-plus-g" aria-hidden="true">
                                                    </i>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="linkedin-bg-hvr" href="javascript:void(0);">
                            ...
                            <div class="team-box item">
                                <div class="team-image">
                                    <img src="assets/images/team-img-4.jpg" alt="image">
                                </div>
                                <div class="team-text">
                                    <h5 class="main-font">
                                        William Smith
                            ...
                            <div class="team-box item">
                                <div class="team-image">
                                    <img src="assets/images/team-img-5.jpg" alt="image">
                                </div>
                                <div class="team-text">
                                    <h5 class="main-font">
                                        Ella Anderson
        ...
        <section class="section slide4 portfolio-bg" id="portfolio">
            <div class="bg-overlay text-light-black opacity-8">
            </div>
            <div class="container">
                        ...
                        <div class="team-classic owl-team owl-carousel text-center">
                            <div class="item">
                                <div class="team-data-img">
                                    <a href="assets/images/portfolio-img-5.jpg" data-fancybox="portfolio-images">
                                        <div class="single-work">
                                            <img src="assets/images/portfolio-img-1.jpg" alt="team" class="img-responsive" data-no-retina>
                                            <div class="overlay-text center-block">
                                                <div class="cases-image-inner">
                                                    <span class="cases-line top">
                                                    </span>
                                                    <span class="cases-line top-right">
                                                    </span>
                                                    <span class="cases-line bottom">
                                                    </span>
                                                    <span class="cases-line bottom-left">
                                                    </span>
                                                    <div class="image-overlay">
                                                        ...
                                                        <h6 class="text-white text-uppercase alt-font">
                                                            View Project
                                                        </h6>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="portfolio-content">
                                        <h5 class="text-yellow main-font mb-2 text-uppercase">
                            ...
                            <div class="item">
                                <div class="team-data-img">
                                    <a href="https://vimeo.com/198376997" data-fancybox="portfolio-images">
                                        <div class="single-work">
                                            <img src="assets/images/portfolio-img-2.jpg" alt="team" class="img-responsive" data-no-retina>
                                            <div class="overlay-text center-block">
                                                <div class="cases-image-inner">
                                                    <span class="cases-line top">
                                                    </span>
                            ...
                            <div class="item">
                                <div class="team-data-img">
                                    <a href="assets/images/portfolio-img-3.jpg" data-fancybox="portfolio-images">
                                        <div class="single-work">
                                            <img src="assets/images/portfolio-img-3.jpg" alt="team" class="img-responsive" data-no-retina>
                                            <div class="overlay-text center-block">
                                                <div class="cases-image-inner">
                                                    <span class="cases-line top">
                                                    </span>
                            ...
                            <div class="item">
                                <div class="team-data-img">
                                    <a href="assets/images/portfolio-img-4.jpg" data-fancybox="portfolio-images">
                                        <div class="single-work">
                                            <img src="assets/images/portfolio-img-4.jpg" alt="team" class="img-responsive" data-no-retina>
                                            <div class="overlay-text center-block">
                                                <div class="cases-image-inner">
                                                    <span class="cases-line top">
                                                    </span>
        ...
        <section class="section slide6 blog-bg" id="blog">
            <div class="bg-overlay bg-blue opacity-8">
            </div>
            <div class="container expand-container">
                <div class="row align-items-center section-heading">
                            ...
                            <div class="item">
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-8 offset-md-1">
                                        <div class="icon-quotes-left mb-3">
                                            <i class="fas fa-quote-left">
                                            </i>
                                        </div>
                                        <div class="description text-center text-md-right">
                                            <p class="text-white paragraph">
                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu. Lorem ipsum dolor sit amet.
                                            </p>
                                        </div>
                                        <div class="icon-quotes-right mt-md-3">
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="testimonial-img">
                                            <span data-tootik="Sara Jones" data-tootik-conf="top dark square shadow">
                                                <img src="assets/images/testimonial-img-1.png" alt="student img">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="testimonial-img">
                                            <span data-tootik="Danial Bryan" data-tootik-conf="top dark square shadow">
                                                <img src="assets/images/testimonial-img-2.png" alt="student img">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 col-md-3">
                                        <div class="testimonial-img">
                                            <span data-tootik="Dean Ambrose" data-tootik-conf="top dark square shadow">
                                                <img src="assets/images/testimonial-img-3.png" alt="student img">
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 blog-left wow" data-wow-delay=".6s">
                        <div class="news-item">
                            <div class="image-holder-gallary">
                                <img alt="image" src="assets/images/blog-img-1.jpg">
                            </div>
                            <div class="news-text-box">
                                <a href="#">
                                    <h4 class="news-title main-font">
                                        Design Trends 2020
                                    </h4>
                                </a>
                                <p class="para alt-font">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu. Lorem ipsum dolor sit amet.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-md-4 blog-center wow" data-wow-delay=".6s">
                        <div class="news-item">
                            <div class="image-holder-gallary">
                                <img alt="image" src="assets/images/blog-img-2.jpg">
                            </div>
                            <div class="news-text-box">
                                <a href="#">
                                    <h4 class="news-title main-font">
                                ...
                                <p class="para alt-font">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4 blog-right wow" data-wow-delay=".6s">
                        <div class="news-item">
                            <div class="image-holder-gallary">
                                <img alt="image" src="assets/images/blog-img-3.jpg">
                            </div>
                            <div class="news-text-box">
                                <a href="#">
                                    <h4 class="news-title main-font">
                                ...
                                <p class="para alt-font">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mauris arcu. Lorem ipsum dolor sit amet, Nunc mauris arcu.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section slide5 contact-sec" id="contact">
            <div class="bg-overlay bg-red opacity-9">
            </div>
            <div class="container expand-container">
                <div class="row">
                    <div class="col-12 col-lg-7 section6left wow" data-wow-delay=".8s">
                        <h4 class="heading text-center text-md-left main-font">
                            Questions?
                            <span class="d-block">
                                Let's Get In Touch
                            </span>
                        ...
                        <form class="row contact-form wow fadeInLeft" id="contact-form-data">
                            <div class="col-12 col-lg-8" id="result">
                            </div>
                            <div class="col-12 col-lg-8">
                                ...
                                <textarea class="form-control" name="userMessage" rows="6" placeholder="Type Your Message Here">
                                </textarea>
                                <a href="javascript:void(0);" class="btn btn-medium btn-rounded btn-white rounded-pill w-100 contact_btn main-font">
                                    Submit Information
                                </a>
                            </div>
                        </form>
                    ...
                    <div class="col-12 col-lg-5 section6left wow text-center text-lg-left d-flex align-items-center" data-wow-delay=".8s">
                        <div class="contact-details wow fadeInRight">
                            <h4 class="heading main-font">
                                Office Location
                            </h4>
                            <p class="text alt-font">
                            ...
                            <ul>
                                ...
                                <li>
                                    <i aria-hidden="true" class="fas fa-phone-volume">
                                    </i>
                                    <span>
                                        +1 631 1234 5678
                                    </span>
    ...
    <div class="slider-bottom cursor-light">
        ...
        <div class="slider-copyright text-white link">
            <span>
                &copy; 2024 Megaone.
            </span>
        </div>
    ...
    <script src="assets/js/jquery.pagepiling.min.js">
    </script>
